    ...
    <section id="home" className="relative min-h-screen bg-gradient-to-r from-gray-900 to-gray-800 text-white overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 pt-20 pb-16 flex items-center min-h-screen">
        <div className="w-full md:w-1/2">
          ...
          <p className="text-xl mb-8 text-gray-300">THE BEST CAKE IN BIRATNAGAR</p>
          
          <div className="flex flex-col sm:flex-row gap-4">
            <button 
              onClick={() => scrollToSection('menu')}
              className="bg-orange-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-orange-600 transition-colors flex items-center justify-center space-x-2"
            >
              <ShoppingBag size={20} />
              <span>Order Now</span>
            </button>
            <button 
              ...
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-colors flex items-center justify-center space-x-2"
            >
              <Play size={20} />
