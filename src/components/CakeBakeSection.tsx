...
const CakeBakeSection = () => {
  ...
  return <section id="cake-bake" className="py-20 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {currentCategory?.items.map(item => <div key={item.id} className="bg-gray-50 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
        ...
        {/* Item Details Modal */}
        {selectedItem && <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-hidden">
              <ScrollArea className="h-[90vh]">
                <div className="p-6">
                  ...
                  <img src={selectedItem.image} alt={selectedItem.name} className="w-full h-64 object-cover rounded-lg mb-6" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    <div>
                      ...
                      <ul className="space-y-2">
                        {selectedItem.ingredients.map((ingredient: any, index: number) => <li key={index} className="text-gray-600 flex justify-between">
